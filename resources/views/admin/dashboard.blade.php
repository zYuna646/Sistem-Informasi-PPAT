            ...
            <div class="card border-0 zoom-in bg-light-primary shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-primary mb-1"> Notaris </p>
                        <h5 class="fw-semibold text-primary mb-0">{{ $count_notaris ?? 0 }}</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 zoom-in bg-light-warning shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-warning mb-1"> Verificator </p>
                        <h5 class="fw-semibold text-warning mb-0">{{ $count_verificator ?? 0 }}</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 zoom-in bg-light-danger shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <h5 class="fw-semibold text-danger mb-0">{{ $count_accepted_report ?? 0 }}</h5>
                    </div>
                </div>
            </div>
        </div>
