  ...
  <form action="{{ route('admin.laporan.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-12">
          <div class="mb-3">
            <label class="control-label mb-1">Pelaporan <span class="text-danger">*</span></label>
            <select name="laporan_pelaporan" class="form-control form-select @error('laporan_pelaporan') is-invalid @enderror">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="laporan_pihak_memberikan"
              class="form-control @error('laporan_pihak_memberikan') is-invalid @enderror" placeholder="..."
              value="{{ old('laporan_pihak_memberikan') }}" />
            @error('laporan_pihak_memberikan')
            <small class="invalid-feedback">
              {{ $message }}
            </small>
            @enderror
          ...
          <div class="mb-3">
            ...
            <input type="text" name="laporan_pihak_menerima"
              class="form-control @error('laporan_pihak_menerima') is-invalid @enderror" placeholder="..."
              value="{{ old('laporan_pihak_menerima') }}" />
            @error('laporan_pihak_menerima')
            <small class="invalid-feedback">
              {{ $message }}
            </small>
            @enderror
