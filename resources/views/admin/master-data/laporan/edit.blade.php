...
<div class="card">
  <form action="{{ route('admin.laporan.update', $data->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-12">
          <div class="mb-3">
            <label class="control-label mb-1">Pelaporan </label>
            <select name="laporan_pelaporan"
              class="form-control form-select @error('laporan_pelaporan') is-invalid @enderror">
              <option value="" selected hidden>-- Select Pelaporan --</option>
              @foreach ($pelaporans as $pelaporan)
              <option value="{{ $pelaporan->id }}" {{ $data->pelaporan_id == $pelaporan->id ? 'selected' : '' }}>
                {{ $pelaporan->nomor_ijin }} - {{ $pelaporan->user->name }}
              </option>
              @endforeach
            </select>
            @error('laporan_pelaporan')
          ...
          <div class="mb-3">
            ...
            <input type="text" name="npwp_pihak_menerima"
          ...
          <div class="mb-3">
            ...
            <input type="text" name="npwp_pihak_memberikan"
          ...
          <div class="mb-3">
            ...
            <input type="text" name="jenis_nomor" class="form-control @error('jenis_nomor') is-invalid @enderror"
              placeholder="..." value="{{ old('jenis_nomor', $data->jenis_nomor) }}" />
            @error('jenis_nomor')
            <small class="invalid-feedback">
              {{ $message }}
            </small>
          ...
          <div class="mb-3">
            ...
            <input type="text" name="letak_tanah" class="form-control @error('letak_tanah') is-invalid @enderror"
              placeholder="..." value="{{ old('letak_tanah', $data->letak_tanah) }}" />
            @error('letak_tanah')
            <small class="invalid-feedback">
              {{ $message }}
            </small>
          ...
          <div class="mb-3">
            ...
            <input type="text" name="harga_transaksi"
          ...
          <div class="mb-3">
            ...
            <input type="text" name="sppt_njop" class="form-control @error('sppt_njop') is-invalid @enderror"
              placeholder="..."
          ...
          <div class="mb-3">
            ...
            <input type="text" name="sppt_nop_tahun" class="form-control @error('sppt_nop_tahun') is-invalid @enderror"
              placeholder="..."
          ...
          <div class="mb-3">
            ...
            <input type="text" name="ssp_harga_ssp" class="form-control @error('ssp_harga_ssp') is-invalid @enderror"
              placeholder="..."
          ...
          <div class="mb-3">
            ...
            <input type="date" name="ssp_tanggal_ssp"
          ...
          <div class="mb-3">
            ...
            <input type="text" name="ssb_harga_ssb" class="form-control @error('ssb_harga_ssb') is-invalid @enderror"
              placeholder="..."
          ...
          <div class="mb-3">
            ...
            <input type="date" name="ssb_tanggal_ssb"
          ...
          <div class="mb-3">
            ...
            <input type="text" name="ket" class="form-control @error('ket') is-invalid @enderror" placeholder="..."
              value="{{ old('ket', $data->ket) }}" />
            @error('ket')
            <small class="invalid-feedback">
              {{ $message }}
            </small>
