  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
        <a href="{{ route('admin.laporan_perorangan.create', $laporan->id ) }}"
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{ route('admin.laporan_perorangan.edit', ['id' => $laporan->id, 'idPerorangan' => $result->id]) }}"
                class="btn btn-sm btn-info">
                <i class="ti ti-pencil"></i>
              </a>
              <form
                action="{{ route('admin.laporan_perorangan.delete', ['id' => $laporan->id, 'idPerorangan' => $result->id]) }}"
...
<div class="card">
  <div class="card-body">
    <div class="alert alert-warning mb-0" role="alert">
      <div class="d-flex gap-2 align-items-center">
        <span class="rounded-circle px-1 py-0 border border-2 border-warning text-light bg-warning mb-0 d-block"
