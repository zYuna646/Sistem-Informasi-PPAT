...
<div class="card">
  <form action="{{ route('admin.verificator.update', $data->id) }}" method="post">
    @csrf
    @method('put')
    <div class="card-body">
        ...
        <div class="col-12">
          <div class="mb-3">
            ...
            <input type="text" name="verificator_name"
              class="form-control @error('verificator_name') is-invalid @enderror" placeholder="..."
              value="{{ old('verificator_name', $data->name) }}" />
          ...
          <div class="mb-3">
            ...
            <input type="email" name="verificator_email"
              class="form-control @error('verificator_email') is-invalid @enderror" placeholder="..."
              value="{{ old('verificator_email', $data->email) }}" />
          ...
          <div class="mb3">
            ...
            <input type="password" name="verificator_password_confirmation"
              class="form-control @error('verificator_password_confirmation') is-invalid @enderror" placeholder="..."
              value="{{ old('verificator_password_confirmation') }}" />
            @error('verificator_password_confirmation')
            <small class="invalid-feedback">
              {{ $message }}
            </small>
            @enderror
