            ...
            <div class="card border-0 zoom-in bg-light-primary shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-primary mb-1"> Laporan Yang Di Terima </p>
            ...
            <div class="card border-0 zoom-in bg-light-warning shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-warning mb-1"> Laporan Yang Di Tolak </p>
            ...
            <div class="card border-0 zoom-in bg-light-secondary shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-secondary mb-1"> Jumlah Laporan </p>
